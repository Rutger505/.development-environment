...
o.bind("ALT + F10", "GSR save replay", "gsr-ui-cli replay-save")
o.bind("ALT + F11", "GSR save replay (1 min)", "gsr-ui-cli replay-save-1-min")
o.bind("ALT + F12", "GSR save replay (10 min)", "gsr-ui-cli replay-save-10-min")
